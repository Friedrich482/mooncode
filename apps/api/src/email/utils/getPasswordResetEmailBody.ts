const getPasswordResetEmailBody = (code: string) =>
            ...
            <tr>
              <td style="padding: 25px 0">
                ...
                <p
                  ...
                  "
                >
                  Someone recently requested a password change for your MoonCode account. If this was you, here is your reset code:
                </p>
                <p
                  style="
                    margin: 20px auto;
            ...
            <tr>
              <td style="padding: 0 0 25px 0">
                <p
                  ...
                  "
                >
                  If you did not try to reset your password, you can safely ignore and delete this
                  email.
                </p>
              </td>
            </tr>
...
export default getPasswordResetEmailBody;
