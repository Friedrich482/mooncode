export const getEmailUpdateEmailBody = (code: string) => {
            ...
            <tr>
              <td style="padding: 25px 0">
                ...
                <p
                  ...
                  "
                >
                  Someone recently requested an email update to this email address for a MoonCode account. If this was you, here is your email update code:
                </p>
                <p
                  style="
                    margin: 20px auto;
