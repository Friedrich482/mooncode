...
import { GroupByDropDown } from "../dashboard-page/groupby-dropdown";
import { PeriodDropDown } from "../dashboard-page/period-dropdown";
...
const ProjectTimeOnPeriodChart = lazy(async () => ({
  default: (await import("./charts/project-time-on-period-chart"))
    .ProjectTimeOnPeriodChart,
}));
const ProjectLanguagesTimeOnPeriodChart = lazy(async () => 
   ({
    default: (await import("./charts/project-languages-time-on-period-chart"))
      .ProjectLanguagesTimeOnPeriodChart,
  })
);
const FilesCirclePackingChart = lazy(async () => ({
  default: (
    await import("./charts/files-circle-packing-chart/files-circle-packing-chart")
